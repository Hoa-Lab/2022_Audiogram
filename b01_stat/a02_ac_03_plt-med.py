...
#---------------------------------------------------------
fd_out='./out/a02_ac_03_plt-med'
f_in='./out/a02_ac_01_plt-case/data.csv'
...
#--------------------------------------------------------
def plt_line(df, f_out, title=None, cmap=cmap, sz=(8,3), ylbl='Abs Difference (Db)'):
	sns.set()
	sns.despine()
	#plot
...
#########################################################################
#plot
f_out=f'{fd_out}/ac.png'
title='Median Difference of Db (Air Conduct)'
